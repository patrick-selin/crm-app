...
import { registerUser, loginUser, getAuthDetails, refreshToken } from "./auth-controller";
...
describe("Auth Controller Unit Tests", () => {
    ...
    describe("registerUser Controller", () => {
      it("should register a user and return 201", async () => {
        ...
        expect(res.json).toHaveBeenCalledWith({
          ...
          user: { id: mockUser.userId, username: mockUser.username, email: mockUser.email },
        });
    ...
    describe("getAuthDetails Controller", () => {
      it("should return authenticated user details", async () => {
        ...
        vi.spyOn(authService, "getAuthDetails").mockResolvedValue(mockUserDetails);
        ...
        expect(authService.getAuthDetails).toHaveBeenCalledWith(mockUserDetails.id);
        expect(res.status).toHaveBeenCalledWith(200);
    ...
    describe("refreshToken Controller", () => {
      it("should refresh tokens for a valid request", async () => {
        ...
        vi.spyOn(authService, "refreshToken").mockResolvedValue(mockRefreshResponse);
        ...
        expect(authService.refreshToken).toHaveBeenCalledWith(req.body.refreshToken);
        expect(res.status).toHaveBeenCalledWith(200);
